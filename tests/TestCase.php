...
namespace JoaoJ\LaravelClickhouse\Tests;
...
class TestCase extends Orchestra
{
    ...
    {
        return [
            \JoaoJ\LaravelClickhouse\LaravelClickhousePackageServiceProvider::class,
            \JoaoJ\LaravelClickhouse\LaravelClickhouseServiceProvider::class,
        ];
    }
